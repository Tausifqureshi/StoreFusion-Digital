...
function Testimonial() {
  const { mode, testimonial } = useContext(MyContext);
      ...
      <div className="container px-5 py-10 mx-auto">
        ...
        <div className="flex flex-wrap -m-4">
          {testimonial.map((item) => (
            <div key={item.id} className="lg:w-1/3 p-4">
              <div
              ...
              >
                <img
                  ...
                  src={item.img|| "/default-user.png"}
                  alt=""
                />

                <p className="mb-3 text-center">{item.text}</p>
