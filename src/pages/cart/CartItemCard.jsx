...
const CartItemCard = ({
  ...
  return (
    <div className={`p-4 md:p-6 rounded-[24px] border-2 transition-all ${isDark ? "bg-[#1a1f2e] border-gray-700" : "bg-white border-gray-100 shadow-sm"}`}>
      <div className="flex flex-row gap-4 md:gap-6">
        {/* Image */}
        <div
          className={`w-24 h-24 md:w-32 md:h-32 rounded-2xl p-2 flex shrink-0 items-center justify-center overflow-hidden border-2 bg-transparent ${isDark ? "border-gray-700" : "bg-white border-gray-50 shadow-inner"}`}
        >
        ...
        <div className="flex-1 min-w-0">
          ...
          <div className="mt-2">
            ...
            {isDescOpen && (
              <div className={`mt-2 p-3 rounded-xl text-[11px] leading-relaxed font-bold ${isDark ? "bg-[#1a1f2e] text-gray-400" : "bg-gray-50 text-gray-600"}`}>
          ...
          <div className="flex items-center justify-between mt-4">
            ...
            <div className={`flex items-center gap-3 px-3 py-1 rounded-xl border ${isDark ? "bg-[#1a1f2e] border-gray-800" : "bg-gray-50 border-gray-100"}`}>
