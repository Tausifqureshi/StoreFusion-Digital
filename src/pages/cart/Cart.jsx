    ...
    <Layout>
      ...
      >
        ...
        <div className="mx-auto max-w-5xl px-6 md:flex md:space-x-6 xl:px-0">
          ...
          <div className="md:w-2/3">
            ...
            >
              ...
              <div className="sm:ml-4 sm:flex sm:w-full sm:justify-between">
                ...
                <div className="mt-4 sm:mt-0 flex flex-col sm:block sm:space-x-6">
                  {/* Quantity Design */}
                  <div className="flex items-center space-x-2">
                    <button className="px-2 py-1 text-lg font-semibold bg-gray-300 rounded hover:bg-gray-400">
                      -
                    </button>
                    <span
          ...
          {/* Checkout Summary Section */}
          <div
            className={`mt-6 h-full p-6 rounded-lg border shadow-md md:mt-0 md:w-1/3 ${
              mode === "dark" ? "bg-gray-800" : "bg-white"
            }`}
          >
            <div className="mb-2 flex justify-between">
