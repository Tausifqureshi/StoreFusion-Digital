...
import { saveCartToFirestore, clearUserCartFromFirestore, saveGuestCartToFirestore, clearGuestCartFromFirestore   } from "./cartFirestore";
...
function Cart() {
  ...
  const deleteCart = async (item) => {
    ...
    toast.info("Item deleted from cart", { position: "top-right", autoClose: 1000, icon: "🗑️" });
