...
function Cart({ cartLoading }) {
                    ...
                    return (
                      ...
                      >
                        <div className="flex gap-6">
                          ...
                          <div
                            className={`w-24 h-24 md:w-32 md:h-32 rounded-2xl p-2 flex items-center justify-center border ${
                              isDark
                          ...
                          <div className="flex-1">
                            <div className="flex justify-between">
                              <div>
                                ...
                                <h2 className="text-sm md:text-lg font-black uppercase">
                                  {item.title}
                                </h2>
                              </div>
                            ...
                            <div className="mt-2">
                              <button
                                onClick={() => toggleDesc(index)}
                                className="flex items-center gap-1 text-blue-600 text-[10px] font-black uppercase"
                              >
                              ...
                              {isDescOpen && (
                                <div
                                  className={`mt-2 p-3 rounded-xl text-[11px] ${
                                    isDark
                                      ? "bg-[#131921] text-gray-400"
                            ...
                            <div className="flex justify-between mt-4">
                              ...
                              <div
                                className={`flex items-center gap-3 px-3 py-1 rounded-xl border ${
                                  isDark
                                    ? "bg-[#131921] border-gray-700"
                                    : "bg-gray-50 border-gray-100"
                                }`}
                              >
                                <button
                                  onClick={() => decrementCartQuantity(item.id)}
                                  disabled={cartUpdating?.id === item.id}
                                >
                                  {cartUpdating?.id === item.id &&
                                  cartUpdating?.type === "decrement" ? (
                                    <span className="w-3 h-3 border-2 border-blue-600 border-t-transparent rounded-full animate-spin block"></span>
                                  ) : (
                                    <FiMinus />
                                  )}
                                </button>
  ...
  onClick={clearCartItems}
  disabled={clearingCart}
  className="w-full py-3 text-[9px] font-black uppercase border mt-3 rounded-xl flex items-center justify-center gap-2"
>
  {clearingCart ? (
    <>
    ...
    "Clear Shopping Bag"
              ...
              <div className="flex flex-col items-center justify-center py-20 text-center">
                <h2 className="text-2xl font-black uppercase opacity-20">
                  Your Bag is Empty
                </h2>

                <Link
                  to="/allproducts"
                  className="mt-4 px-8 py-3 bg-blue-600 text-white text-[10px] font-black uppercase rounded-xl"
                >
                  Continue Shopping
                </Link>
              </div>
