...
function Cart() {
  ...
  // const totalWithShipping = (totalAmount + shippingCharge).toFixed(2); // Total including shipping

  // Total Me Add Shipping Charg product Empty to shipping Chrag bhi zero.
  const shippingCharge = 20; // Fixed shipping charge
  const totalWithShipping = totalAmount > 0 //Agar totalAmount 0 se bada hai, iska matlab hai ki cart mein koi products hain tab hi shipping charge include Total me hoga warna zero.
  ? (totalAmount + shippingCharge).toFixed(2) // Total including shipping if items exist
  : 0; // If no items, total with shipping is 0
