...
// ✅ STATIC ACTIONS: Outside to prevent re-creation
const ACTIONS = [
...
function QuickActions({ isDark, navigate }) {
  return (
    <div className={`p-8 rounded-3xl border transition-all flex flex-col justify-center h-full w-full ${isDark ? 'bg-[#1a1f2e] border-gray-800 shadow-[0_8px_30px_rgba(0,0,0,0.3)]' : 'bg-white border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)]'}`}>
