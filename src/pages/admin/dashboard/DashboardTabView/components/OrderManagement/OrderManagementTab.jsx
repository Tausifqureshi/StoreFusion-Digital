...
const OrderManagementTab = ({ isDark, order = [] }) => {
  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      {/* 👉 ORDERS LIST VIEW */}
      <div className={`rounded-3xl p-6 md:p-8 transition-all duration-300 mb-8 ${isDark ? 'bg-[#1e293b] border border-gray-800' : 'bg-white border border-gray-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)]'}`}>
