...
const ProductCard = ({ item, isDark, edithandle, deleteProduct }) => {
  ...
  const rating = Number(item.rating) || 4.5; // Dummy if missing, since no rating in standard product
  ...
  if (stock === 0) {
    ...
    status = "Draft"; // Just illustrating dynamic badges like the screenshot
