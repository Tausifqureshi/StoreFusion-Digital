...
function ProductInfo() {
  ...
  const handleAddToCart = () => {
    const isProductInCart = cartItems.some((item) => item.id === currentProduct.id);
    if (isProductInCart) {
            ...
            <div className="w-full lg:w-[50%] flex flex-col space-y-6 text-center lg:text-left">
              ...
              <div className="py-2 md:py-4 border-b border-gray-100 dark:border-gray-800">
                <div className="flex items-end justify-center lg:justify-start gap-3 mb-1">
                  ...
                  {discount > 0 && <span className="text-lg md:text-xl line-through text-gray-400 font-bold mb-1">₹{currentProduct.price}</span>}
                </div>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                <button onClick={handleAddToCart} className="flex-[2] py-4 rounded-2xl bg-blue-600 hover:bg-blue-700 text-white font-black uppercase tracking-widest text-[10px] md:text-[11px] shadow-xl shadow-blue-500/20 transition-all active:scale-95">
                  Add To Shopping Bag
                </button>
                ...
                <button onClick={() => setIsHeartFilled(!isHeartFilled)} className={`p-4 md:p-5 rounded-2xl border flex items-center justify-center transition-all ${isHeartFilled ? "bg-red-500 border-red-500 text-white" : "border-gray-200 text-gray-400"}`}>
                  <FaHeart size={18} />
                </button>
              </div>
            </div>
          ...
          {similarProducts.length > 0 && (
            <section className="mt-12 lg:mt-24 border-t border-gray-100 dark:border-gray-800 pt-8 px-2 md:px-0">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 md:gap-4 lg:gap-6">
                ...
                <img src={item.imageUrl} alt={item.title} className="max-h-full w-auto object-contain transition-transform duration-500 group-hover:scale-105" />
                    </div>
                    <div className="flex-1 flex flex-col justify-between">
                      <div>
                        <p className="text-[7px] md:text-[9px] font-black text-orange-500 uppercase tracking-widest mb-1">{item.category}</p>
                        <h3 className={`font-bold text-[10px] md:text-xs lg:text-sm uppercase tracking-tight line-clamp-2 leading-tight mb-2 ${isDark ? "text-gray-200" : "text-gray-800"}`}>{item.title}</h3>
                      </div>
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mt-auto">
                        ...
                        <div className="flex items-center gap-1">
                          <span className="hidden sm:inline-block text-[7px] font-black bg-blue-50 text-blue-600 px-1.5 py-0.5 rounded uppercase border border-blue-100">Premium</span>
