                        ...
                        <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                            ...
                            <div className="flex mb-4">
                                ...
                                <span className="flex ml-3 pl-3 py-2 border-l-2 border-gray-200 space-x-3">
                                    <a className="text-gray-600 hover:text-indigo-600 transition-colors">
                                        <svg
                                            fill="currentColor"
                                            strokeLinecap="round"
                                            strokeLinejoin="round"
                            ...
                            <p className="leading-relaxed border-b-2 mb-6 pb-6 text-gray-700">
                                ...
                                Gastropub blue bottle austin listicle pour-over, neutra jean shorts keytar
                            ...
                            <div className="flex">
                                ...
                                <button className="flex ml-auto text-white bg-indigo-500 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600 transition-shadow shadow-md rounded">
                                    Add To Cart
                                </button>
